...
public final class JMHSample_29_StatesDAG_test {
    ...
    public Collection<? extends Result> test_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Shared_1_jmh l_shared3_G = _jmh_tryInit_f_shared3_G(control, threadParams);
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_29_StatesDAG_1_jmh l_jmhsample_29_statesdag0_0 = _jmh_tryInit_f_jmhsample_29_statesdag0_0(control, threadParams);
            Local_1_jmh l_local2_2 = _jmh_tryInit_f_local2_2(control, threadParams, l_shared3_G);
            ...
            test_thrpt_jmhLoop(control, res, l_local2_2, l_jmhsample_29_statesdag0_0, l_blackhole1_1, l_shared3_G);
            ...
            if (control.isLastIteration()) {
                if (l_local2_2.readyTrial) {
                    l_local2_2.readyTrial = false;
                }
                while(!Shared_1_jmh.tearTrialMutexUpdater.compareAndSet(l_shared3_G, 0, 1)) {
                ...
                try {
                    ...
                    Shared_1_jmh.tearTrialMutexUpdater.set(l_shared3_G, 0);
                }
                while(!Shared_1_jmh.tearTrialMutexUpdater.compareAndSet(l_shared3_G, 0, 1)) {
                    if (Thread.interrupted()) throw new InterruptedException();
                }
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "test", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void test_thrpt_jmhLoop(InfraControl control, RawResults result, Local_1_jmh l_local2_2, JMHSample_29_StatesDAG_1_jmh l_jmhsample_29_statesdag0_0, Blackhole_1_jmh l_blackhole1_1, Shared_1_jmh l_shared3_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> test_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Shared_1_jmh l_shared3_G = _jmh_tryInit_f_shared3_G(control, threadParams);
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_29_StatesDAG_1_jmh l_jmhsample_29_statesdag0_0 = _jmh_tryInit_f_jmhsample_29_statesdag0_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            test_avgt_jmhLoop(control, res, l_local2_2, l_jmhsample_29_statesdag0_0, l_blackhole1_1, l_shared3_G);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "test", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void test_avgt_jmhLoop(InfraControl control, RawResults result, Local_1_jmh l_local2_2, JMHSample_29_StatesDAG_1_jmh l_jmhsample_29_statesdag0_0, Blackhole_1_jmh l_blackhole1_1, Shared_1_jmh l_shared3_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> test_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Shared_1_jmh l_shared3_G = _jmh_tryInit_f_shared3_G(control, threadParams);
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_29_StatesDAG_1_jmh l_jmhsample_29_statesdag0_0 = _jmh_tryInit_f_jmhsample_29_statesdag0_0(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            test_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_local2_2, l_jmhsample_29_statesdag0_0, l_blackhole1_1, l_shared3_G);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_jmhsample_29_statesdag0_0.test(l_local2_2));
    ...
    public void test_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Local_1_jmh l_local2_2, JMHSample_29_StatesDAG_1_jmh l_jmhsample_29_statesdag0_0, Blackhole_1_jmh l_blackhole1_1, Shared_1_jmh l_shared3_G) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> test_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Shared_1_jmh l_shared3_G = _jmh_tryInit_f_shared3_G(control, threadParams);
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_29_StatesDAG_1_jmh l_jmhsample_29_statesdag0_0 = _jmh_tryInit_f_jmhsample_29_statesdag0_0(control, threadParams);
    ...
    public void test_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Local_1_jmh l_local2_2, JMHSample_29_StatesDAG_1_jmh l_jmhsample_29_statesdag0_0, Blackhole_1_jmh l_blackhole1_1, Shared_1_jmh l_shared3_G) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile Shared_1_jmh f_shared3_G;
    
    Shared_1_jmh _jmh_tryInit_f_shared3_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_shared3_G == null) {
                f_shared3_G = new Shared_1_jmh();
            }
            if (!f_shared3_G.readyTrial) {
                f_shared3_G.setup();
                f_shared3_G.readyTrial = true;
            }
        }
        return f_shared3_G;
    }
    ...
    JMHSample_29_StatesDAG_1_jmh f_jmhsample_29_statesdag0_0;
    
    JMHSample_29_StatesDAG_1_jmh _jmh_tryInit_f_jmhsample_29_statesdag0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (f_jmhsample_29_statesdag0_0 == null) {
            JMHSample_29_StatesDAG_1_jmh val = new JMHSample_29_StatesDAG_1_jmh();
            val.readyTrial = true;
            f_jmhsample_29_statesdag0_0 = val;
        }
        return f_jmhsample_29_statesdag0_0;
    }
    
    Local_1_jmh f_local2_2;
    
    Local_1_jmh _jmh_tryInit_f_local2_2(InfraControl control, ThreadParams threadParams, Shared_1_jmh l_shared3_G) throws Throwable {
        if (f_local2_2 == null) {
            Local_1_jmh val = new Local_1_jmh();
    ...
    static class JMHSample_29_StatesDAG_1_jmh_B1 extends org.sample.sample.JMHSample_29_StatesDAG {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class JMHSample_29_StatesDAG_1_jmh_B2 extends JMHSample_29_StatesDAG_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_29_StatesDAG_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_29_StatesDAG_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_29_StatesDAG_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_29_StatesDAG_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_29_StatesDAG_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_29_StatesDAG_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class JMHSample_29_StatesDAG_1_jmh_B3 extends JMHSample_29_StatesDAG_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class JMHSample_29_StatesDAG_1_jmh extends JMHSample_29_StatesDAG_1_jmh_B3 {
    }
    
    static class Local_1_jmh_B1 extends org.sample.sample.JMHSample_29_StatesDAG.Local {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class Local_1_jmh_B2 extends Local_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Local_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Local_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Local_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Local_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Local_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Local_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class Local_1_jmh_B3 extends Local_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class Local_1_jmh extends Local_1_jmh_B3 {
    }
    
    static class Shared_1_jmh_B1 extends org.sample.sample.JMHSample_29_StatesDAG.Shared {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class Shared_1_jmh_B2 extends Shared_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Shared_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Shared_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Shared_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Shared_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Shared_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Shared_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class Shared_1_jmh_B3 extends Shared_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class Shared_1_jmh extends Shared_1_jmh_B3 {
    }
