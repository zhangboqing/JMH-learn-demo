...
public final class JMHSample_07_FixtureLevelInvocation_measureCold {
    ...
    public Collection<? extends Result> measureCold_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_07_FixtureLevelInvocation_1_jmh l_jmhsample_07_fixturelevelinvocation0_0 = _jmh_tryInit_f_jmhsample_07_fixturelevelinvocation0_0(control, threadParams);
            Scratch_1_jmh l_scratch3_2 = _jmh_tryInit_f_scratch3_2(control, threadParams);
            LaggingState_1_jmh l_laggingstate2_G = _jmh_tryInit_f_laggingstate2_G(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                while(!LaggingState_1_jmh.setupInvocationMutexUpdater.compareAndSet(l_laggingstate2_G, 0, 1)) {
                ...
                try {
                    ...
                    LaggingState_1_jmh.setupInvocationMutexUpdater.set(l_laggingstate2_G, 0);
                }

                l_blackhole1_1.consume(l_jmhsample_07_fixturelevelinvocation0_0.measureCold(l_laggingstate2_G, l_scratch3_2));

                while(!LaggingState_1_jmh.tearInvocationMutexUpdater.compareAndSet(l_laggingstate2_G, 0, 1)) {
                    if (Thread.interrupted()) throw new InterruptedException();
                }
                try {
                    if (l_laggingstate2_G.readyInvocation) {
                    ...
                    LaggingState_1_jmh.tearInvocationMutexUpdater.set(l_laggingstate2_G, 0);
                }

            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureCold_thrpt_jmhLoop(control, res, l_laggingstate2_G, l_scratch3_2, l_jmhsample_07_fixturelevelinvocation0_0, l_blackhole1_1);
            ...
            if (control.isLastIteration()) {
                while(!LaggingState_1_jmh.tearTrialMutexUpdater.compareAndSet(l_laggingstate2_G, 0, 1)) {
                    if (Thread.interrupted()) throw new InterruptedException();
                }
                try {
                    ...
                    LaggingState_1_jmh.tearTrialMutexUpdater.set(l_laggingstate2_G, 0);
                }
                while(!LaggingState_1_jmh.tearTrialMutexUpdater.compareAndSet(l_laggingstate2_G, 0, 1)) {
                    if (Thread.interrupted()) throw new InterruptedException();
                }
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "measureCold", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void measureCold_thrpt_jmhLoop(InfraControl control, RawResults result, LaggingState_1_jmh l_laggingstate2_G, Scratch_1_jmh l_scratch3_2, JMHSample_07_FixtureLevelInvocation_1_jmh l_jmhsample_07_fixturelevelinvocation0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> measureCold_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_07_FixtureLevelInvocation_1_jmh l_jmhsample_07_fixturelevelinvocation0_0 = _jmh_tryInit_f_jmhsample_07_fixturelevelinvocation0_0(control, threadParams);
            Scratch_1_jmh l_scratch3_2 = _jmh_tryInit_f_scratch3_2(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureCold_avgt_jmhLoop(control, res, l_laggingstate2_G, l_scratch3_2, l_jmhsample_07_fixturelevelinvocation0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "measureCold", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void measureCold_avgt_jmhLoop(InfraControl control, RawResults result, LaggingState_1_jmh l_laggingstate2_G, Scratch_1_jmh l_scratch3_2, JMHSample_07_FixtureLevelInvocation_1_jmh l_jmhsample_07_fixturelevelinvocation0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> measureCold_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_07_FixtureLevelInvocation_1_jmh l_jmhsample_07_fixturelevelinvocation0_0 = _jmh_tryInit_f_jmhsample_07_fixturelevelinvocation0_0(control, threadParams);
            Scratch_1_jmh l_scratch3_2 = _jmh_tryInit_f_scratch3_2(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            measureCold_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_laggingstate2_G, l_scratch3_2, l_jmhsample_07_fixturelevelinvocation0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    while(!LaggingState_1_jmh.setupInvocationMutexUpdater.compareAndSet(l_laggingstate2_G, 0, 1)) {
    ...
    public void measureCold_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, LaggingState_1_jmh l_laggingstate2_G, Scratch_1_jmh l_scratch3_2, JMHSample_07_FixtureLevelInvocation_1_jmh l_jmhsample_07_fixturelevelinvocation0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> measureCold_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_07_FixtureLevelInvocation_1_jmh l_jmhsample_07_fixturelevelinvocation0_0 = _jmh_tryInit_f_jmhsample_07_fixturelevelinvocation0_0(control, threadParams);
            Scratch_1_jmh l_scratch3_2 = _jmh_tryInit_f_scratch3_2(control, threadParams);
    ...
    public void measureCold_ss_jmhStub(InfraControl control, int batchSize, RawResults result, LaggingState_1_jmh l_laggingstate2_G, Scratch_1_jmh l_scratch3_2, JMHSample_07_FixtureLevelInvocation_1_jmh l_jmhsample_07_fixturelevelinvocation0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile LaggingState_1_jmh f_laggingstate2_G;
    
    LaggingState_1_jmh _jmh_tryInit_f_laggingstate2_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_laggingstate2_G == null) {
                f_laggingstate2_G = new LaggingState_1_jmh();
            }
            if (!f_laggingstate2_G.readyTrial) {
                f_laggingstate2_G.up();
                f_laggingstate2_G.readyTrial = true;
            }
        }
        return f_laggingstate2_G;
    }
    ...
    JMHSample_07_FixtureLevelInvocation_1_jmh f_jmhsample_07_fixturelevelinvocation0_0;
    
    JMHSample_07_FixtureLevelInvocation_1_jmh _jmh_tryInit_f_jmhsample_07_fixturelevelinvocation0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (f_jmhsample_07_fixturelevelinvocation0_0 == null) {
            JMHSample_07_FixtureLevelInvocation_1_jmh val = new JMHSample_07_FixtureLevelInvocation_1_jmh();
            val.readyTrial = true;
            f_jmhsample_07_fixturelevelinvocation0_0 = val;
        }
        return f_jmhsample_07_fixturelevelinvocation0_0;
    }
    
    Scratch_1_jmh f_scratch3_2;
    
    Scratch_1_jmh _jmh_tryInit_f_scratch3_2(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (f_scratch3_2 == null) {
            Scratch_1_jmh val = new Scratch_1_jmh();
            val.readyTrial = true;
            f_scratch3_2 = val;
        }
        return f_scratch3_2;
    ...
    static class JMHSample_07_FixtureLevelInvocation_1_jmh_B1 extends org.sample.sample.JMHSample_07_FixtureLevelInvocation {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class JMHSample_07_FixtureLevelInvocation_1_jmh_B2 extends JMHSample_07_FixtureLevelInvocation_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_07_FixtureLevelInvocation_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_07_FixtureLevelInvocation_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_07_FixtureLevelInvocation_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_07_FixtureLevelInvocation_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_07_FixtureLevelInvocation_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_07_FixtureLevelInvocation_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class JMHSample_07_FixtureLevelInvocation_1_jmh_B3 extends JMHSample_07_FixtureLevelInvocation_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class JMHSample_07_FixtureLevelInvocation_1_jmh extends JMHSample_07_FixtureLevelInvocation_1_jmh_B3 {
    }
    
    static class LaggingState_1_jmh_B1 extends org.sample.sample.JMHSample_07_FixtureLevelInvocation.LaggingState {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class LaggingState_1_jmh_B2 extends LaggingState_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(LaggingState_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(LaggingState_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(LaggingState_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(LaggingState_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(LaggingState_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(LaggingState_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class LaggingState_1_jmh_B3 extends LaggingState_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class LaggingState_1_jmh extends LaggingState_1_jmh_B3 {
    }
    
    static class Scratch_1_jmh_B1 extends org.sample.sample.JMHSample_07_FixtureLevelInvocation.Scratch {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class Scratch_1_jmh_B2 extends Scratch_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Scratch_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Scratch_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Scratch_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Scratch_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Scratch_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Scratch_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class Scratch_1_jmh_B3 extends Scratch_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class Scratch_1_jmh extends Scratch_1_jmh_B3 {
    }
