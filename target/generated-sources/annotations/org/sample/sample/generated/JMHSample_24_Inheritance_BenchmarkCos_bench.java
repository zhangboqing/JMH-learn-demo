...
public final class JMHSample_24_Inheritance_BenchmarkCos_bench {
    ...
    public Collection<? extends Result> bench_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            BenchmarkCos_1_jmh l_benchmarkcos0_0 = _jmh_tryInit_f_benchmarkcos0_0(control, threadParams);
            ...
            bench_thrpt_jmhLoop(control, res, l_benchmarkcos0_0, l_blackhole1_1);
            ...
            if (control.isLastIteration()) {
                if (l_benchmarkcos0_0.readyTrial) {
                    l_benchmarkcos0_0.readyTrial = false;
                }
    ...
    public void bench_thrpt_jmhLoop(InfraControl control, RawResults result, BenchmarkCos_1_jmh l_benchmarkcos0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> bench_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            bench_avgt_jmhLoop(control, res, l_benchmarkcos0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void bench_avgt_jmhLoop(InfraControl control, RawResults result, BenchmarkCos_1_jmh l_benchmarkcos0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> bench_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            bench_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_benchmarkcos0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_benchmarkcos0_0.bench());
    ...
    public void bench_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, BenchmarkCos_1_jmh l_benchmarkcos0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public void bench_ss_jmhStub(InfraControl control, int batchSize, RawResults result, BenchmarkCos_1_jmh l_benchmarkcos0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    BenchmarkCos_1_jmh f_benchmarkcos0_0;
    
    BenchmarkCos_1_jmh _jmh_tryInit_f_benchmarkcos0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (f_benchmarkcos0_0 == null) {
            BenchmarkCos_1_jmh val = new BenchmarkCos_1_jmh();
            val.setup();
            val.readyTrial = true;
            f_benchmarkcos0_0 = val;
        }
        return f_benchmarkcos0_0;
    }
    ...
    static class BenchmarkCos_1_jmh_B1 extends org.sample.sample.JMHSample_24_Inheritance.BenchmarkCos {
    ...
    static class BenchmarkCos_1_jmh_B2 extends BenchmarkCos_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkCos_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkCos_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkCos_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkCos_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkCos_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkCos_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class BenchmarkCos_1_jmh_B3 extends BenchmarkCos_1_jmh_B2 {
    ...
    static final class BenchmarkCos_1_jmh extends BenchmarkCos_1_jmh_B3 {
    }
