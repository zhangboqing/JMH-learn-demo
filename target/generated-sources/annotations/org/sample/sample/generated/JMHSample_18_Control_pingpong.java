...
public final class JMHSample_18_Control_pingpong {
    ...
    public Collection<? extends Result> pingpong_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Control_1_jmh l_control2_G = _jmh_tryInit_f_control2_G(control, threadParams);
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G = _jmh_tryInit_f_jmhsample_18_control0_G(control, threadParams);
            ...
            while(!Control_1_jmh.setupIterationMutexUpdater.compareAndSet(l_control2_G, 0, 1)) {
            ...
            try {
                ...
                Control_1_jmh.setupIterationMutexUpdater.set(l_control2_G, 0);
            }
            ...
            ping_thrpt_jmhLoop(control, res, l_control2_G, l_jmhsample_18_control0_G, l_blackhole1_0);
            ...
            while(!Control_1_jmh.tearIterationMutexUpdater.compareAndSet(l_control2_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            try {
                if (l_control2_G.readyIteration) {
                ...
                Control_1_jmh.tearIterationMutexUpdater.set(l_control2_G, 0);
            }
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "ping", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            results.add(new ThroughputResult(ResultRole.SECONDARY, "ping", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            l_control2_G.startMeasurement = true;
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            pong_thrpt_jmhLoop(control, res, l_control2_G, l_jmhsample_18_control0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            l_control2_G.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new ThroughputResult(ResultRole.PRIMARY, "pong", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            results.add(new ThroughputResult(ResultRole.SECONDARY, "pong", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void ping_thrpt_jmhLoop(InfraControl control, RawResults result, Control_1_jmh l_control2_G, JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public void pong_thrpt_jmhLoop(InfraControl control, RawResults result, Control_1_jmh l_control2_G, JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> pingpong_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Control_1_jmh l_control2_G = _jmh_tryInit_f_control2_G(control, threadParams);
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G = _jmh_tryInit_f_jmhsample_18_control0_G(control, threadParams);
            ...
            l_control2_G.startMeasurement = true;
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            ping_avgt_jmhLoop(control, res, l_control2_G, l_jmhsample_18_control0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            l_control2_G.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "ping", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            results.add(new AverageTimeResult(ResultRole.SECONDARY, "ping", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
        if (threadParams.getSubgroupIndex() == 1) {
            Control_1_jmh l_control2_G = _jmh_tryInit_f_control2_G(control, threadParams);
            ...
            l_control2_G.startMeasurement = true;
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            pong_avgt_jmhLoop(control, res, l_control2_G, l_jmhsample_18_control0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            l_control2_G.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "pong", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            results.add(new AverageTimeResult(ResultRole.SECONDARY, "pong", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void ping_avgt_jmhLoop(InfraControl control, RawResults result, Control_1_jmh l_control2_G, JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public void pong_avgt_jmhLoop(InfraControl control, RawResults result, Control_1_jmh l_control2_G, JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> pingpong_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Control_1_jmh l_control2_G = _jmh_tryInit_f_control2_G(control, threadParams);
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G = _jmh_tryInit_f_jmhsample_18_control0_G(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            ping_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_control2_G, l_jmhsample_18_control0_G, l_blackhole1_0);
            l_control2_G.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            SampleBuffer buffer = new SampleBuffer();
            pong_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_control2_G, l_jmhsample_18_control0_G, l_blackhole1_0);
            l_control2_G.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void ping_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Control_1_jmh l_control2_G, JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public void pong_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Control_1_jmh l_control2_G, JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        int rnd = (int)System.nanoTime();
        int rndMask = startRndMask;
        long time = 0;
    ...
    public Collection<? extends Result> pingpong_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Control_1_jmh l_control2_G = _jmh_tryInit_f_control2_G(control, threadParams);
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G = _jmh_tryInit_f_jmhsample_18_control0_G(control, threadParams);
    ...
    public void ping_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Control_1_jmh l_control2_G, JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    public void pong_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Control_1_jmh l_control2_G, JMHSample_18_Control_1_jmh l_jmhsample_18_control0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile Control_1_jmh f_control2_G;
    
    Control_1_jmh _jmh_tryInit_f_control2_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_control2_G == null) {
                f_control2_G = new Control_1_jmh();
            }
            if (!f_control2_G.readyTrial) {
                f_control2_G.readyTrial = true;
            }
        }
        return f_control2_G;
    }
    ...
    static java.util.Map<Integer, JMHSample_18_Control_1_jmh> f_jmhsample_18_control0_G_map = java.util.Collections.synchronizedMap(new java.util.HashMap<Integer, JMHSample_18_Control_1_jmh>());
    
    JMHSample_18_Control_1_jmh _jmh_tryInit_f_jmhsample_18_control0_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            JMHSample_18_Control_1_jmh local = f_jmhsample_18_control0_G_map.get(threadParams.getGroupIndex());
            if (local == null) {
                JMHSample_18_Control_1_jmh val = new JMHSample_18_Control_1_jmh();
    ...
    static class Control_1_jmh_B1 extends org.openjdk.jmh.infra.Control {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class Control_1_jmh_B2 extends Control_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Control_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Control_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Control_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Control_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Control_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Control_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class Control_1_jmh_B3 extends Control_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class Control_1_jmh extends Control_1_jmh_B3 {
    }
    
    static class JMHSample_18_Control_1_jmh_B1 extends org.sample.sample.JMHSample_18_Control {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
    ...
    static class JMHSample_18_Control_1_jmh_B2 extends JMHSample_18_Control_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_18_Control_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_18_Control_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_18_Control_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_18_Control_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_18_Control_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(JMHSample_18_Control_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class JMHSample_18_Control_1_jmh_B3 extends JMHSample_18_Control_1_jmh_B2 {
        private boolean pb3_0, pb3_0_1, pb3_0_2, pb3_0_3, pb3_0_4, pb3_0_5, pb3_0_6, pb3_0_7, pb3_0_8, pb3_0_9, pb3_0_10, pb3_0_11, pb3_0_12, pb3_0_13, pb3_0_14, pb3_0_15;
        private boolean pb3_1, pb3_1_1, pb3_1_2, pb3_1_3, pb3_1_4, pb3_1_5, pb3_1_6, pb3_1_7, pb3_1_8, pb3_1_9, pb3_1_10, pb3_1_11, pb3_1_12, pb3_1_13, pb3_1_14, pb3_1_15;
        private boolean pb3_2, pb3_2_1, pb3_2_2, pb3_2_3, pb3_2_4, pb3_2_5, pb3_2_6, pb3_2_7, pb3_2_8, pb3_2_9, pb3_2_10, pb3_2_11, pb3_2_12, pb3_2_13, pb3_2_14, pb3_2_15;
        private boolean pb3_3, pb3_3_1, pb3_3_2, pb3_3_3, pb3_3_4, pb3_3_5, pb3_3_6, pb3_3_7, pb3_3_8, pb3_3_9, pb3_3_10, pb3_3_11, pb3_3_12, pb3_3_13, pb3_3_14, pb3_3_15;
    ...
    static final class JMHSample_18_Control_1_jmh extends JMHSample_18_Control_1_jmh_B3 {
    }
