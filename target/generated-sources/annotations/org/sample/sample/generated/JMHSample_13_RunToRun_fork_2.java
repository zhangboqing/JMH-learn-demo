...
public final class JMHSample_13_RunToRun_fork_2 {
    ...
    public Collection<? extends Result> fork_2_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            fork_2_thrpt_jmhLoop(control, res, l_sleepystate2_2, l_jmhsample_13_runtorun0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "fork_2", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void fork_2_thrpt_jmhLoop(InfraControl control, RawResults result, SleepyState_1_jmh l_sleepystate2_2, JMHSample_13_RunToRun_1_jmh l_jmhsample_13_runtorun0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> fork_2_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_13_RunToRun_1_jmh l_jmhsample_13_runtorun0_0 = _jmh_tryInit_f_jmhsample_13_runtorun0_0(control, threadParams);
            SleepyState_1_jmh l_sleepystate2_2 = _jmh_tryInit_f_sleepystate2_2(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            fork_2_avgt_jmhLoop(control, res, l_sleepystate2_2, l_jmhsample_13_runtorun0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "fork_2", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void fork_2_avgt_jmhLoop(InfraControl control, RawResults result, SleepyState_1_jmh l_sleepystate2_2, JMHSample_13_RunToRun_1_jmh l_jmhsample_13_runtorun0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> fork_2_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_13_RunToRun_1_jmh l_jmhsample_13_runtorun0_0 = _jmh_tryInit_f_jmhsample_13_runtorun0_0(control, threadParams);
            SleepyState_1_jmh l_sleepystate2_2 = _jmh_tryInit_f_sleepystate2_2(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            fork_2_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_sleepystate2_2, l_jmhsample_13_runtorun0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_jmhsample_13_runtorun0_0.fork_2(l_sleepystate2_2);
    ...
    public void fork_2_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, SleepyState_1_jmh l_sleepystate2_2, JMHSample_13_RunToRun_1_jmh l_jmhsample_13_runtorun0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> fork_2_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_13_RunToRun_1_jmh l_jmhsample_13_runtorun0_0 = _jmh_tryInit_f_jmhsample_13_runtorun0_0(control, threadParams);
            SleepyState_1_jmh l_sleepystate2_2 = _jmh_tryInit_f_sleepystate2_2(control, threadParams);
    ...
    public void fork_2_ss_jmhStub(InfraControl control, int batchSize, RawResults result, SleepyState_1_jmh l_sleepystate2_2, JMHSample_13_RunToRun_1_jmh l_jmhsample_13_runtorun0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
