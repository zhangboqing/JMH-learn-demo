...
public final class JMHSample_38_PerInvokeSetup_measureRight {
    ...
    public Collection<? extends Result> measureRight_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            Data_1_jmh l_data2_G = _jmh_tryInit_f_data2_G(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_jmhsample_38_perinvokesetup0_0.measureRight(l_data2_G));
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureRight_thrpt_jmhLoop(control, res, l_data2_G, l_jmhsample_38_perinvokesetup0_0, l_blackhole1_1);
            ...
            if (control.isLastIteration()) {
                while(!Data_1_jmh.tearTrialMutexUpdater.compareAndSet(l_data2_G, 0, 1)) {
                ...
                try {
                    ...
                    Data_1_jmh.tearTrialMutexUpdater.set(l_data2_G, 0);
                }
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "measureRight", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void measureRight_thrpt_jmhLoop(InfraControl control, RawResults result, Data_1_jmh l_data2_G, JMHSample_38_PerInvokeSetup_1_jmh l_jmhsample_38_perinvokesetup0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> measureRight_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_38_PerInvokeSetup_1_jmh l_jmhsample_38_perinvokesetup0_0 = _jmh_tryInit_f_jmhsample_38_perinvokesetup0_0(control, threadParams);
            Data_1_jmh l_data2_G = _jmh_tryInit_f_data2_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureRight_avgt_jmhLoop(control, res, l_data2_G, l_jmhsample_38_perinvokesetup0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "measureRight", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void measureRight_avgt_jmhLoop(InfraControl control, RawResults result, Data_1_jmh l_data2_G, JMHSample_38_PerInvokeSetup_1_jmh l_jmhsample_38_perinvokesetup0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> measureRight_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_38_PerInvokeSetup_1_jmh l_jmhsample_38_perinvokesetup0_0 = _jmh_tryInit_f_jmhsample_38_perinvokesetup0_0(control, threadParams);
            Data_1_jmh l_data2_G = _jmh_tryInit_f_data2_G(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            measureRight_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_data2_G, l_jmhsample_38_perinvokesetup0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_jmhsample_38_perinvokesetup0_0.measureRight(l_data2_G));
    ...
    public void measureRight_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Data_1_jmh l_data2_G, JMHSample_38_PerInvokeSetup_1_jmh l_jmhsample_38_perinvokesetup0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> measureRight_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_38_PerInvokeSetup_1_jmh l_jmhsample_38_perinvokesetup0_0 = _jmh_tryInit_f_jmhsample_38_perinvokesetup0_0(control, threadParams);
            Data_1_jmh l_data2_G = _jmh_tryInit_f_data2_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            measureRight_ss_jmhStub(control, batchSize, res, l_data2_G, l_jmhsample_38_perinvokesetup0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_blackhole1_1.readyIteration) {
                l_blackhole1_1.readyIteration = false;
            }
    ...
    public void measureRight_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Data_1_jmh l_data2_G, JMHSample_38_PerInvokeSetup_1_jmh l_jmhsample_38_perinvokesetup0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile Data_1_jmh f_data2_G;
    
    Data_1_jmh _jmh_tryInit_f_data2_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_data2_G == null) {
                f_data2_G = new Data_1_jmh();
            }
            if (!f_data2_G.readyTrial) {
                Field f;
                f = org.sample.sample.JMHSample_38_PerInvokeSetup.Data.class.getDeclaredField("count");
                f.setAccessible(true);
                f.set(f_data2_G, Integer.valueOf(control.getParam("count")));
                f_data2_G.setup();
                f_data2_G.readyTrial = true;
            }
        }
        return f_data2_G;
    }
