...
public final class JMHSample_21_ConsumeCPU_consume_0004 {
    ...
    public Collection<? extends Result> consume_0004_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            consume_0004_thrpt_jmhLoop(control, res, l_jmhsample_21_consumecpu0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "consume_0004", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void consume_0004_thrpt_jmhLoop(InfraControl control, RawResults result, JMHSample_21_ConsumeCPU_1_jmh l_jmhsample_21_consumecpu0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> consume_0004_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_21_ConsumeCPU_1_jmh l_jmhsample_21_consumecpu0_0 = _jmh_tryInit_f_jmhsample_21_consumecpu0_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            consume_0004_avgt_jmhLoop(control, res, l_jmhsample_21_consumecpu0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "consume_0004", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void consume_0004_avgt_jmhLoop(InfraControl control, RawResults result, JMHSample_21_ConsumeCPU_1_jmh l_jmhsample_21_consumecpu0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> consume_0004_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_21_ConsumeCPU_1_jmh l_jmhsample_21_consumecpu0_0 = _jmh_tryInit_f_jmhsample_21_consumecpu0_0(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            consume_0004_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_jmhsample_21_consumecpu0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_jmhsample_21_consumecpu0_0.consume_0004();
    ...
    public void consume_0004_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, JMHSample_21_ConsumeCPU_1_jmh l_jmhsample_21_consumecpu0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> consume_0004_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            JMHSample_21_ConsumeCPU_1_jmh l_jmhsample_21_consumecpu0_0 = _jmh_tryInit_f_jmhsample_21_consumecpu0_0(control, threadParams);
    ...
    public void consume_0004_ss_jmhStub(InfraControl control, int batchSize, RawResults result, JMHSample_21_ConsumeCPU_1_jmh l_jmhsample_21_consumecpu0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
