...
public final class JMHSample_26_BatchSize_measureRight {
    ...
    public Collection<? extends Result> measureRight_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            measureRight_thrpt_jmhLoop(control, res, l_jmhsample_26_batchsize0_0, l_blackhole1_1);
    ...
    public void measureRight_thrpt_jmhLoop(InfraControl control, RawResults result, JMHSample_26_BatchSize_1_jmh l_jmhsample_26_batchsize0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> measureRight_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureRight_avgt_jmhLoop(control, res, l_jmhsample_26_batchsize0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void measureRight_avgt_jmhLoop(InfraControl control, RawResults result, JMHSample_26_BatchSize_1_jmh l_jmhsample_26_batchsize0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> measureRight_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            measureRight_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_jmhsample_26_batchsize0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_jmhsample_26_batchsize0_0.measureRight());
    ...
    public void measureRight_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, JMHSample_26_BatchSize_1_jmh l_jmhsample_26_batchsize0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public void measureRight_ss_jmhStub(InfraControl control, int batchSize, RawResults result, JMHSample_26_BatchSize_1_jmh l_jmhsample_26_batchsize0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
