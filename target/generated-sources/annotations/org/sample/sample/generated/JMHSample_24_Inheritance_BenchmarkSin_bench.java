...
public final class JMHSample_24_Inheritance_BenchmarkSin_bench {
    ...
    public Collection<? extends Result> bench_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            BenchmarkSin_1_jmh l_benchmarksin0_0 = _jmh_tryInit_f_benchmarksin0_0(control, threadParams);
            ...
            bench_thrpt_jmhLoop(control, res, l_benchmarksin0_0, l_blackhole1_1);
            ...
            if (control.isLastIteration()) {
                if (l_benchmarksin0_0.readyTrial) {
                    l_benchmarksin0_0.readyTrial = false;
                }
    ...
    public void bench_thrpt_jmhLoop(InfraControl control, RawResults result, BenchmarkSin_1_jmh l_benchmarksin0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> bench_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            bench_avgt_jmhLoop(control, res, l_benchmarksin0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void bench_avgt_jmhLoop(InfraControl control, RawResults result, BenchmarkSin_1_jmh l_benchmarksin0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> bench_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            bench_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_benchmarksin0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_benchmarksin0_0.bench());
    ...
    public void bench_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, BenchmarkSin_1_jmh l_benchmarksin0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public void bench_ss_jmhStub(InfraControl control, int batchSize, RawResults result, BenchmarkSin_1_jmh l_benchmarksin0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    BenchmarkSin_1_jmh f_benchmarksin0_0;
    
    BenchmarkSin_1_jmh _jmh_tryInit_f_benchmarksin0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (f_benchmarksin0_0 == null) {
            BenchmarkSin_1_jmh val = new BenchmarkSin_1_jmh();
            val.setup();
            val.readyTrial = true;
            f_benchmarksin0_0 = val;
        }
        return f_benchmarksin0_0;
    }
    ...
    static class BenchmarkSin_1_jmh_B1 extends org.sample.sample.JMHSample_24_Inheritance.BenchmarkSin {
    ...
    static class BenchmarkSin_1_jmh_B2 extends BenchmarkSin_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkSin_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkSin_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkSin_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkSin_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkSin_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkSin_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class BenchmarkSin_1_jmh_B3 extends BenchmarkSin_1_jmh_B2 {
    ...
    static final class BenchmarkSin_1_jmh extends BenchmarkSin_1_jmh_B3 {
    }
