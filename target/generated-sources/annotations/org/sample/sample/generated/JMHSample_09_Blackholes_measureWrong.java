...
public final class JMHSample_09_Blackholes_measureWrong {
    ...
    public Collection<? extends Result> measureWrong_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            measureWrong_thrpt_jmhLoop(control, res, l_jmhsample_09_blackholes0_0, l_blackhole1_1);
    ...
    public void measureWrong_thrpt_jmhLoop(InfraControl control, RawResults result, JMHSample_09_Blackholes_1_jmh l_jmhsample_09_blackholes0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> measureWrong_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            measureWrong_avgt_jmhLoop(control, res, l_jmhsample_09_blackholes0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void measureWrong_avgt_jmhLoop(InfraControl control, RawResults result, JMHSample_09_Blackholes_1_jmh l_jmhsample_09_blackholes0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> measureWrong_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            measureWrong_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_jmhsample_09_blackholes0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_jmhsample_09_blackholes0_0.measureWrong());
    ...
    public void measureWrong_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, JMHSample_09_Blackholes_1_jmh l_jmhsample_09_blackholes0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public void measureWrong_ss_jmhStub(InfraControl control, int batchSize, RawResults result, JMHSample_09_Blackholes_1_jmh l_jmhsample_09_blackholes0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
