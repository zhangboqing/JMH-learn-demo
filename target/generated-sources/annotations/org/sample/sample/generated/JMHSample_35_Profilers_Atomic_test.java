...
public final class JMHSample_35_Profilers_Atomic_test {
    ...
    public Collection<? extends Result> test_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            Atomic_1_jmh l_atomic0_G = _jmh_tryInit_f_atomic0_G(control, threadParams);
            ...
            test_thrpt_jmhLoop(control, res, l_atomic0_G, l_blackhole1_0);
            ...
            if (control.isLastIteration()) {
                while(!Atomic_1_jmh.tearTrialMutexUpdater.compareAndSet(l_atomic0_G, 0, 1)) {
                ...
                try {
                    ...
                    Atomic_1_jmh.tearTrialMutexUpdater.set(l_atomic0_G, 0);
                }
    ...
    public void test_thrpt_jmhLoop(InfraControl control, RawResults result, Atomic_1_jmh l_atomic0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> test_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            test_avgt_jmhLoop(control, res, l_atomic0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void test_avgt_jmhLoop(InfraControl control, RawResults result, Atomic_1_jmh l_atomic0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> test_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            test_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_atomic0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_atomic0_G.test());
    ...
    public void test_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Atomic_1_jmh l_atomic0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public void test_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Atomic_1_jmh l_atomic0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile Atomic_1_jmh f_atomic0_G;
    
    Atomic_1_jmh _jmh_tryInit_f_atomic0_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        synchronized(this.getClass()) {
            if (f_atomic0_G == null) {
                f_atomic0_G = new Atomic_1_jmh();
            }
            if (!f_atomic0_G.readyTrial) {
                f_atomic0_G.setup();
                f_atomic0_G.readyTrial = true;
            }
        }
        return f_atomic0_G;
    }
    ...
    static class Atomic_1_jmh_B1 extends org.sample.sample.JMHSample_35_Profilers.Atomic {
    ...
    static class Atomic_1_jmh_B2 extends Atomic_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Atomic_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Atomic_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Atomic_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Atomic_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Atomic_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(Atomic_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class Atomic_1_jmh_B3 extends Atomic_1_jmh_B2 {
    ...
    static final class Atomic_1_jmh extends Atomic_1_jmh_B3 {
    }
